...
/**
 ...
 Una lista de correos electrónicos extraídos de los leads.
*/
export const getEmailsFromLeads = async (): Promise<string[]> => {
  try {
    const response = await axios.get("http://microservice-leads:3000/leads"); // URL del microservicio de leads
